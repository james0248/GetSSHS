...
class App extends Component {
    constructor(props) {
        ...
        window.localStorage.setItem(
            'highestScore',
            this.state.highestScore.toString()
        )
            ...
            <div className="card">
                <div className="game-container">
                    <div className="header">
                        ...
                        <div className="score-container">
                            ...
                            <div className="score highest">
                                HIGHEST
                                <br />
                                <span>{this.state.highestScore}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <p className="game-info explanation">
                        ...
                        <br />
                        <strong>NOTE:</strong> The order of the high schools are
                        not intended to be a ranking, instead it's a rough
                        south-to-north geographical path to SSHS. This game is a{' '}
                        <a href="http://sshs.hs.kr/index.do">SSHS </a> version
                        of the game 2048.
                    </p>
                    <hr />
                    <p className="explanation">
                        Created by{' '}
                        <a href="https://github.com/james0248">
                            Hyeonseok Jung.
                        </a>{' '}
                        Inspired by{' '}
                        <a href="https://mitchgu.github.io/GetMIT/">GetMIT</a>.
                        It's a clone of{' '}
